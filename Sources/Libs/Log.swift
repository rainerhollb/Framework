...
public class Log : Describable {
   ...
   /**
    ...
    Experiences with sequencially written files:
    
    In simulators audio gets in endless loop, whole simulation running host (iMac) gets affected, also Music app!
    In real devices app terminiates.
